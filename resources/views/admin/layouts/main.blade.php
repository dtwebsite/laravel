...
<head>
    ...
    <!-- SweetAlert2 -->
    <link href="{{ asset('gentelella/vendors/SweetAlert2/sweetalert2.min.css') }}" rel="stylesheet">
  ...
  <body class="nav-md">
    ...
    <!-- SweetAlert2 -->
    <script src="{{ asset('gentelella/vendors/SweetAlert2/sweetalert2.min.js') }}"></script>
    <!-- Flot -->
